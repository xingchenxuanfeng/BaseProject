...
public abstract class FileCallBack extends Callback<File> {
    ...
    /**
     * 总大小，为了兼容resp中的contentLength字段可能不存在的情况，支持主动设置备用的总大小
     */
    long defaultTotalSize = 0;


    public FileCallBack(String destFileDir, String destFileName, long defaultTotalSize) {
    ...
    public File saveFile(Response response, final int id) throws IOException {
        ...
        final long totalSize = contentLength > 0 ? contentLength : defaultTotalSize;
