//copy from https://github.com/emilsjolander/StickyScrollViewItems
...
public class StickyScrollView extends ScrollView {
    ...
    private int getLeftForViewRelativeOnlyChild(View v) {
        ...
        //fix bug : add left margin of scrollview's child
        left = left + getChildAt(0).getLeft();
        return left;
    }
