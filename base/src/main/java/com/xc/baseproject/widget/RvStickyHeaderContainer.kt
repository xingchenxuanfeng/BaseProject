package com.xc.baseproject.widget
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if (currentStickyHeaderPosition != relativeStickyHeaderPosition) {
                ...
                if (relativeStickyHeaderPosition == -1) {
                    ...
                    if (debug) Timber.d("relativeStickyHeader removed")
                } else {
            ...
            if (relativeStickyHeaderPosition == -1) {
                if (debug) Timber.d("not found relativeStickyHeader")
                return
            }
            ...
            if (debug) Timber.d("firstVisibleItemPosition=$firstVisibleItemPosition relativeStickyHeaderPosition=$relativeStickyHeaderPosition nextStickyHeaderPosition=$nextStickyHeaderPosition lastShowHeaderPosition=$lastShowHeaderPosition realStickHeaderView.height=${realStickHeaderView.height} realStickHeaderView.translationY=${realStickHeaderView.translationY}")
